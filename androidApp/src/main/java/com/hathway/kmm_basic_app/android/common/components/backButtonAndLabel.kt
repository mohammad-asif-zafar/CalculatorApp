...
fun BackButtonAndLabel(onBackClick: () -> Unit, title: String) {
    ...
    Box(
        ...
        Row(
            ...
            IconButton(onClick = { }) {
                Icon(
                    imageVector = Icons.Default.ArrowBack, // Material icon
...
@Preview
@Composable
fun BackButtonAndLabelPreview(modifier: Modifier = Modifier) {
    BackButtonAndLabel({}, stringResource(id = R.string.register))
}